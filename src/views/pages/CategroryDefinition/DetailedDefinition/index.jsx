      ...
      producerActions.deleteProducer(producer.id, {
        ...
        failed: (mess) => {
          notify(
            ...
            "danger",
            "Thông báo",
            `Xóa chi tiết thất bại. Lỗi: ${mess}!`
          );
        },
      })
    );
                    ...
                    {isGetProducers ? (
                      ...
                      <>
                        <Row>
                          <Col>
                            <CardHeader>
                              <h3 className="mb-0">Danh sách chi tiết</h3>
                            </CardHeader>
                          </Col>
                        </Row>
                        ...
                        <Row>
                          ...
                          <Col className="d-flex align-items-center mr-4 justify-content-end">
                            <Row style={{ width: "100%" }}>
                              ...
                              >
                                <h4 className="mb-0">Tìm kiếm tên chi tiết</h4>
                              </Col>
