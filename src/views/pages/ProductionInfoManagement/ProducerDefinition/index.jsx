...
import FormProducerDefinition from "./FormProducerDefinition";
      ...
      producerActions.deleteProducer(producer.id, {
        ...
        failed: (mess) => {
          notify(
            ...
            "danger",
            "Thông báo",
            `Xóa nhà sản xuất thất bại. Lỗi: ${mess}!`
          );
        },
      })
    );
...
export default ProducerDefinition;
