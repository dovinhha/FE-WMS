...
import FormCommandProductionInOutOrder from "./FormCommandProductionInOutOrder";
import ReactNotificationAlert from "react-notification-alert";
const CommandProductionInOutOrder = () => {
  ...
  return (
    <>
      ...
      {formModal && (
        <FormCommandProductionInOutOrder
...
export default CommandProductionInOutOrder;
