...
import FormInventoryDefinition from "./FormInventoryDefinition";
...
const InventoryDefinition = () => {
  ...
  const columns = [
    {
      dataField: "code",
      text: "Mã lệnh kiểm kê",
    },
    {
      dataField: "name",
      text: "Tên lệnh kiểm kê",
    },
    {
      dataField: "address",
      text: "Tên kho",
                    ...
                    {isGetProducers ? (
                      ...
                      <>
                        <Row>
                          <Col>
                            <CardHeader>
                              <h3 className="mb-0">Danh sách kiểm kê</h3>
                            </CardHeader>
                          </Col>
                        </Row>
                        ...
                        <Row>
                          ...
                          <Col className="d-flex align-items-center mr-4 justify-content-end">
                            <Row style={{ width: "100%" }}>
                              ...
                              >
                                <h4 className="mb-0">Tìm kiếm tên kiểm kê</h4>
                              </Col>
