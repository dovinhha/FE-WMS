...
import FormFactoryDefinition from "./FormFactoryDefinition";
                    ...
                    {isGetProducers ? (
                      ...
                      <>
                        <Row>
                          <Col>
                            <CardHeader>
                              <h3 className="mb-0">Danh sách nhà máy</h3>
                            </CardHeader>
                          </Col>
                        </Row>
                        ...
                        <Row>
                          ...
                          <Col className="d-flex align-items-center mr-4 justify-content-end">
                            <Row style={{ width: "100%" }}>
                              ...
                              >
                                <h4 className="mb-0">Tìm kiếm tên nhà máy</h4>
                              </Col>
